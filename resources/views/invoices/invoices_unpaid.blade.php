    ...
    <div class="my-auto">
      <div class="d-flex">
        <h4 class="content-title mb-0 my-auto">الفواتير</h4><span
          class="text-muted mt-1 tx-13 mr-2 mb-0">/ الفواتير
          الغير مدفوعة
        </span>
      </div>
    </div>
      ...
      <div class="card mg-b-20">
        <div class="card-header pb-0">
          <div class="d-flex justify-content-between">
            <a class="modal-effect btn btn-sm btn-primary" href="invoices/create"
              style="color:white"><i class="fas fa-plus"></i>&nbsp; اضافة فاتورة</a>
          </div>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table key-buttons text-md-nowrap" id="example1" data-page-length='50'>
              <thead>
                <tr>
                    ...
                    <td>
                      <div class="dropdown">
                        <button class="btn ripple btn-primary btn-sm" data-toggle="dropdown"
                          type="button" aria-expanded="false" aria-haspopup="true">العمليات<i
                        ...
                        <div class="dropdown-menu tx-13">
                          ...
                          <a class="dropdown-item" data-invoice_id="{{ $invoice->id }}"
                            data-toggle="modal" data-target="#delete_invoice" href="#"><i
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input id="invoice_id" name="invoice_id" type="hidden" value="">
          <input id="btn_action" name="btn_action" type="hidden" value="2">
