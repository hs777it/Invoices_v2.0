...
@section('title')
  تقرير الفواتير - بي سمارت للادارة الفواتير
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
  ...
  <div class="my-auto">
    <div class="d-flex">
      <h4 class="content-title mb-0 my-auto">التقارير</h4><span
        class="text-muted mt-1 tx-13 mr-2 mb-0">/ تقرير
        الفواتير</span>
    </div>
  </div>
</div>
  ...
  <div class="col-xl-12">
    <div class="card mg-b-20">
      ...
      <div class="card-header pb-0">
        ...
        <form role="search" action="/Search_invoices" method="POST" autocomplete="off">
          {{ csrf_field() }}


          <div class="col-lg-3">
            <label class="rdiobox">
              <input id="type_div" name="rdio" type="radio" value="1" checked> <span>بحث
                بنوع
                الفاتورة</span></label>
          </div>
          ...
          <div class="col-lg-3 mg-t-20 mg-lg-t-0">
            <label class="rdiobox"><input name="rdio" type="radio" value="2"><span>بحث
                برقم الفاتورة
              </span></label>
          </div><br><br>
          ...
          <div class="row">
            ...
            <div class="col-lg-3" id="start_at">
              ...
              <div class="input-group">
                ...
                </div><input class="form-control fc-datepicker" name="start_at" type="text"
                  value="{{ $start_at ?? '' }}" placeholder="YYYY-MM-DD">
              </div><!-- input-group -->
            </div>
            ...
            <div class="col-lg-3" id="end_at">
              ...
              <div class="input-group">
                ...
                </div><input class="form-control fc-datepicker" name="end_at" type="text"
...
<script src="{{ URL::asset('assets/plugins/ion-rangeslider/js/ion.rangeSlider.min.js') }}">
</script>
