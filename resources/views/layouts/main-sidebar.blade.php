...
<aside class="app-sidebar sidebar-scroll">
  <div class="main-sidebar-header active">
    <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'home')) }}"><img
        class="main-logo" src="{{ URL::asset('assets/img/brand/logo.png') }}" alt="logo"></a>
    <a class="desktop-logo logo-dark active" href="{{ url('/' . ($page = 'home')) }}"><img
        class="main-logo dark-theme" src="{{ URL::asset('assets/img/brand/logo-white.png') }}"
        alt="logo"></a>
    <a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . ($page = 'home')) }}"><img
        class="logo-icon" src="{{ URL::asset('assets/img/brand/favicon.png') }}" alt="logo"></a>
    <a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . ($page = 'home')) }}"><img
        class="logo-icon dark-theme" src="{{ URL::asset('assets/img/brand/favicon-white.png') }}"
        alt="logo"></a>
  </div>
  <div class="main-sidemenu">
    <div class="app-sidebar__user clearfix">
      <div class="dropdown user-pro-body">
        <div class="">
          <img class="avatar avatar-xl brround" src="{{ URL::asset('assets/img/faces/6.jpg') }}"
            alt="user-img"><span class="avatar-status profile-status bg-green"></span>
        </div>
        <div class="user-info">
    ...
    <ul class="side-menu">
      ...
      <li class="slide">
        <a class="side-menu__item" href="{{ url('/' . ($page = 'home')) }}"><svg
            class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
