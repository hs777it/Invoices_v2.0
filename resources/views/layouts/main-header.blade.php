  ...
  <div class="container-fluid">
    <div class="main-header-left ">
      <div class="responsive-logo">
        <a href="{{ url('/' . ($page = 'index')) }}"><img class="logo-1"
            src="{{ URL::asset('assets/img/brand/logo.png') }}" alt="logo"></a>
        <a href="{{ url('/' . ($page = 'index')) }}"><img class="dark-logo-1"
            src="{{ URL::asset('assets/img/brand/logo-white.png') }}" alt="logo"></a>
        <a href="{{ url('/' . ($page = 'index')) }}"><img class="logo-2"
            src="{{ URL::asset('assets/img/brand/favicon.png') }}" alt="logo"></a>
        <a href="{{ url('/' . ($page = 'index')) }}"><img class="dark-logo-2"
            src="{{ URL::asset('assets/img/brand/favicon.png') }}" alt="logo"></a>
      </div>
      ...
      <div class="main-header-center mr-3 d-sm-none d-md-none d-lg-block">
        <input class="form-control" type="search" placeholder="Search for anything..."> <button
    ...
    <div class="main-header-right">
      <ul class="nav">
        <li class="">
          <div class="dropdown  nav-itemd-none d-md-flex">
            <a class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown"
      ...
      <div class="nav nav-item  navbar-nav-right ml-auto">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                ...
                <button class="btn btn-default nav-link resp-btn" type="submit">
                  <svg class="header-icon-svgs" class="feather feather-search"
        ...
        <div class="dropdown nav-item main-header-message ">
          <a class="new nav-link" href="#"><svg class="header-icon-svgs"
              class="feather feather-mail" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
        ...
        @can('الاشعارات')
          <div class="dropdown nav-item main-header-notification">
            <a class="new nav-link" href="#">
              <svg class="header-icon-svgs" class="feather feather-bell"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round">
            ...
            <div class="dropdown-menu">
              <div class="menu-header-content bg-primary text-right">
                ...
                <h6 id="notifications_count" style="color: yellow">
        ...
        <div class="nav-item full-screen fullscreen-button">
          <a class="new nav-link full-screen-link" href="#"><svg class="header-icon-svgs"
              class="feather feather-maximize" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="dropdown main-profile-menu nav nav-item nav-link">
          <a class="profile-user d-flex" href=""><img
              src="{{ URL::asset('assets/img/faces/6.jpg') }}" alt=""></a>
          <div class="dropdown-menu">
            <div class="main-header-profile bg-primary p-3">
              <div class="d-flex wd-100p">
                <div class="main-img-user"><img class=""
                    src="{{ URL::asset('assets/img/faces/6.jpg') }}" alt=""></div>
            ...
            <form id="logout-form" style="display: none;" action="{{ route('logout') }}"
              method="POST">
              @csrf
        ...
        <div class="dropdown main-header-message right-toggle">
          <a class="nav-link pr-0" data-toggle="sidebar-left" data-target=".sidebar-left">
            <svg class="header-icon-svgs" class="feather feather-menu"
              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round"
              stroke-linejoin="round">
